                  ...
                  >
                    <Routes>
                      ...
                      <Route path={APP_ROUTES.CLEANINGS.LIST}>
                        ...
                        />
                        <Route
                          path={APP_ROUTES.CLEANINGS.EDIT}
                          element={<CleaningEdit />}
                        />
                        <Route
                          path={APP_ROUTES.CLEANINGS.CREATE}
                          element={<CleaningForm />}
                        />
                      </Route>
                      <Route path={APP_ROUTES.CHILDREN.LIST}>
                        <Route
                          path={APP_ROUTES.CHILDREN.LIST}
                          element={<ChildList />}
                        />
                        <Route
                          path={APP_ROUTES.CHILDREN.EDIT}
