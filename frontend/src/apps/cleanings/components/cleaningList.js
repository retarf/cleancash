...
function CleaningList(props) {
  ...
  const addCleaning = () => {
    console.log("TEST");
    console.log({
      date: newCleaningDate.current.value,
      child: newCleaningChild.current.value,
      Fields: newCleaningFields.current.value.split(","),
    });
    props.onAddCleaning(
              ...
              {editOnState ? (
                <Grid item xs={12}>
                  <TextField
                    ...
                    label="Date"
                    variant="outlined"
                    inputRef={newCleaningDate}
                  />
                  <TextField
                    id="child"
                    label="Child"
                    variant="outlined"
                    inputRef={newCleaningChild}
                  />
                  <TextField
                    id="fields"
                    label="Fields"
                    variant="outlined"
                    inputRef={newCleaningFields}
                  />
